...
//
// type: 'minion' | 'spell'
// effect: a small data-driven descriptor interpreted by the
//   engine (see js/engine.js -> resolveEffect). Keeping effects
//   declarative (instead of inline functions) makes the card
//   pool easy to extend when new factions get real art.
//
...
const CARDS = [
  ...
  {
    id: 'h_strike', faction: 'human', type: 'spell', name: '钢铁一击', cost: 1, art: 'human/strike.png',
    text: '对一个随从造成 3 点伤害。',
    effect: { type: 'damageMinion', value: 3 },
  },
  {
    id: 'h_defend', faction: 'human', type: 'spell', name: '沉稳盾墙', cost: 1, art: 'human/defend.png',
    text: '使一个友方随从本回合获得 +0/+4。',
    effect: { type: 'buffMinionTemp', side: 'friendly', atk: 0, hp: 4 },
  },
  {
    id: 'h_heavy_slam', faction: 'human', type: 'spell', name: '破甲重锤', cost: 3, art: 'human/heavy_slam.png',
    text: '对一个随从造成 6 点伤害。',
    effect: { type: 'damageMinion', value: 6 },
  },
  {
    id: 'h_purify', faction: 'human', type: 'spell', name: '圣光治愈', cost: 2, art: 'human/purify.png',
    text: '恢复我方英雄 8 点生命。',
    effect: { type: 'healHero', side: 'friendly', value: 8 },
  },
  {
    id: 'h_cleave', faction: 'human', type: 'spell', name: '横扫千军', cost: 4, art: 'human/cleave.png',
    text: '对所有敌方随从造成 4 点伤害。',
    effect: { type: 'damageAllMinions', side: 'enemy', value: 4 },
  },
  {
    id: 'h_offering', faction: 'human', type: 'spell', name: '热血献祭', cost: 1, art: 'human/offering.png',
    text: '我方英雄失去 3 点生命，抽 2 张牌。',
  ...
  {
    id: 'h_iron_wave', faction: 'human', type: 'spell', name: '铁浪突刺', cost: 2, art: 'human/iron_wave.png',
    text: '对一个随从造成 4 点伤害，恢复我方英雄 4 点生命。',
    effect: { type: 'composite', steps: [
  ...
  {
    id: 'h_iron_arm', faction: 'human', type: 'spell', name: '铁壁之力', cost: 2, art: 'human/iron_arm.png',
    text: '使一个友方随从本回合获得 +0/+6。',
  ...
  {
    id: 'o_rage_strike', faction: 'orc', type: 'spell', name: '狂暴打击', cost: 2,
    text: '对一个随从造成 5 点伤害。',
    effect: { type: 'damageMinion', value: 5 },
  },
  {
    id: 'o_bloodcurse', faction: 'orc', type: 'spell', name: '血怒诅咒', cost: 3,
    text: '对一个随从造成 3 点伤害；若目标死亡，我方一个随机随从本回合获得 +2/+2。',
    effect: { type: 'damageMinionThenBuffRandomIfDied', value: 3, atk: 2, hp: 2 },
  },
  {
    id: 'o_warhorn', faction: 'orc', type: 'spell', name: '部落号角', cost: 1,
    text: '使一个友方随从本回合获得 +2/+0。',
  ...
  {
    id: 'u_soul_siphon', faction: 'undead', type: 'spell', name: '灵魂虹吸', cost: 1,
    text: '对一个随从造成 2 点伤害，我方英雄恢复 2 点生命。',
    effect: { type: 'composite', steps: [
  ...
  {
    id: 'u_death_whisper', faction: 'undead', type: 'spell', name: '死亡低语', cost: 2,
    text: '抽 2 张牌。',
    effect: { type: 'drawCards', side: 'friendly', value: 2 },
  },
  {
    id: 'u_corrosive_touch', faction: 'undead', type: 'spell', name: '腐蚀之触', cost: 3,
    text: '对一个随从造成 4 点伤害；若目标死亡，抽 1 张牌。',
  ...
  {
    id: 'd_sacrificial_flame', faction: 'demon', type: 'spell', name: '献祭之焰', cost: 2,
    text: '我方英雄失去 2 点生命，对一个随从造成 6 点伤害。',
    effect: { type: 'composite', steps: [
  ...
  {
    id: 'd_abyssal_pact', faction: 'demon', type: 'spell', name: '深渊契约', cost: 3,
    text: '抽 3 张牌，我方英雄失去 3 点生命。',
    effect: { type: 'composite', steps: [
  ...
  {
    id: 'd_firestorm', faction: 'demon', type: 'spell', name: '烈焰风暴', cost: 5,
    text: '对所有敌方随从造成 5 点伤害。',
  ...
  {
    id: 'b_wild_call', faction: 'beast', type: 'spell', name: '野性呼唤', cost: 1,
    text: '召唤一个 1/1 的野狼。',
    effect: { type: 'summonMinion', side: 'friendly', attack: 1, health: 1, name: '召唤 · 野狼' },
  },
  {
    id: 'b_fang_bite', faction: 'beast', type: 'spell', name: '尖牙撕咬', cost: 2,
    text: '对一个随从造成 4 点伤害。',
    effect: { type: 'damageMinion', value: 4 },
  },
  {
    id: 'b_totem_ward', faction: 'beast', type: 'spell', name: '图腾庇护', cost: 3,
    text: '使一个友方随从本回合获得 +3/+3。',
